                    ...
                    <div className='lg:grid grid-cols-2 sm:grid grid-rows-2 sm:mb-0'>
                        ...
                        <div className='lg:mx-auto lg:py-36 sm:py-4 sm:mx-auto'>
                            ...
                            <div className='mt-4 p-6 flex  space-x-4 content-center justify-start'>
                                <Link
                                    to='#'
                                    className='  border .border-gray-300 bg-blue-500 hover:bg-blue-700 rounded-full py-2 px-4 text-white mr-2 px-10 '
                                    onClick={() => ProfHandler()}>
                                    Enseignant
                                </Link>
                                <Link
                                    to='#'
                                    className='border .border-gray-300 bg-blue-500 hover:bg-blue-700 rounded-full py-2 px-4 text-white  px-10'
                                    onClick={() => StudHandler()}>
                                    Etudiant
                                </Link>
                            </div>
    ...
    const AccountCreated = () => {
        return (
            <div className='fadein' style={{ display: switchToCon ? 'default' : 'none' }}>
                ...
                <p className='black-70 disable-select' style={{ fontSize: '2rem' }}>
                    Votre compte Naises a été crée avec succés !
                </p>
                <span className='disable-select mr2 orange' style={{ fontSize: '10rem' }}>
                    ❖
                </span>
                <div className='mt6'>
                    <Link to='/connexion' className='NaisesButton br3 shadow-4 disable-select mh3'>
                        Connectez-vous
                    </Link>
                </div>
            </div>
