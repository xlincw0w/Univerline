...
const ProfForm = ({ tools }) => {
    return (
<<<<<<< HEAD
        <div className=' fadein bg-blue-400 rounded-lg  p-6 shadow-2xl' style={{ display: tools.showFormProf ? 'block' : 'none' }}>
            {/* card white*/}
            <div className=' bg-white shadow-2xl  rounded-lg mb-1  lg:h-screen sm:h-full'>
                <div className='flex content-center justify-center mb-4 '>
                    <p className='text-black'> Cher Enseignant</p>
                </div>
                    ...
                    <div style={{ paddingTop: '0rem' }} className='flex content-center justify-center  '>
                        <div>
                            <div className='mb-2 ml-3 mr-4'>
                                ...
                                <input
                                    type='text'
                                    onChange={(e) => tools.setSecond(e.target.value)}
