...
=======
        ...
        <div className=" bg-insc fadein  rounded-lg  p-14 shadow-2xl " style={{ 'display': tools.showFormStud ? 'block' : 'none' }} >
        
          {/* card white*/} 
        <div className="bg-white shadow-2xl  rounded-lg mb-1 h-full sm:h-full">
                   ...
                   <button className=" w-48 px-4 py-2 border-b-2 border-blue-600 hover:bg-blue-500    hover:text-white hover:rounded-lg focus:outline-none focus:shadow-outline "
                    ...
                    <div className="flex content-center justify-center ">
                                <p className="text-black text-4xl"> Cher Etudiant</p>
                    </div>
                      {/* j'ai divisé la card blanche en deux grid*/} 
                <div className="lg:grid grid-cols-2  sm:grid grid-rows-2">
...
>>>>>>> 096925bc7c0da10460a326071559c60342a05071
                            ...
                            <div class='w-full mb-3 sm:w-1/2 sm:pl-2'>
                                <button class='w-full rounded-lg bg-red-700 hover:bg-red-800 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline' type='button'>
                                    {' '}
                                    Google
                                </button>
                            </div>
                    ...
                    <div style={{ paddingTop: '0rem' }} className='flex content-center justify-center  '>
                        <div>
                            <div className='mb-2 ml-3 mr-4'>
                                ...
                                <label
                                    style={{ width: '50px' }}
                                    className={cx('ml-3 text-red-600', { invisible: tools.second.length === 0 || constants.alph_rg.test(tools.second) })}>
                                    Veuillez introduire que des caractères
                                </label>
                            </div>
                            ...
                            <div className='mb-2 ml-3 mr-4'>
                                ...
                                <input
                                    type='text'
                                    onChange={(e) => tools.setFirst(e.target.value)}
                                    className='w-full px-2 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline'
                                />
                                <label
                                    style={{ width: '50px' }}
                                    className={cx('ml-3 f4 text-red-600', { invisible: tools.first.length === 0 || constants.alph_rg.test(tools.first) })}>
                                    Veuillez introduire que des caractères
                                </label>
                            </div>
                            <div className='mb-2 ml-3 mr-4'>
                                ...
                                <input
                                    type='email'
                                    onChange={(e) => tools.setEmail(e.target.value)}
                                    className='w-full px-2 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline'
                                />
                                <label
                                    style={{ width: '50px' }}
                                    className={cx('ml-3 f4 text-red-600', { invisible: tools.email.length === 0 || constants.email_rg.test(tools.email) })}>
                                    Veuillez introduire que des caractères
                                </label>
                            </div>
                            <div className='mb-2 ml-3 mr-4'>
                                ...
                                <input
                                    type='text'
                                    onChange={(e) => tools.setUniversity(e.target.value)}
                                    className='w-full px-2 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline'
                                />
                                <label
                                    style={{ width: '50px' }}
                                    className={cx('ml-3 text-red-600', { invisible: tools.university.length === 0 || constants.alph_rg.test(tools.university) })}>
                                    Veuillez introduire que des caractères
                                </label>
                            </div>
                            <div className='mb-2 ml-3 mr-4'>
                                ...
                                <input
                                    type='text'
                                    onChange={(e) => tools.setDomain(e.target.value)}
                                    className='w-full px-2 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline'
                                />
                                <label
                                    style={{ width: '50px' }}
                                    className={cx('ml-3 text-red-600', { invisible: tools.domain.length === 0 || constants.alph_rg.test(tools.domain) })}>
                                    Veuillez introduire que des caractères
                                </label>
=======
                        <hr className="mt-8 border-t" />
