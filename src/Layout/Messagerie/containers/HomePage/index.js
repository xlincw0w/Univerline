    ...
    return (
        <>
            <Grid container direction='row' alignItems='stretch' style={{ height: '90vh' }}>
                                ...
                                <form className='formulaire' onSubmit={submitMessage}>
                                    <Grid container direction='row'>
                                        <Grid item sm={10} xs={8}>
                                            <input className='champEnvoi' onChange={(e) => setMessage(e.target.value)} value={message} placeholder='votre message...' autoFocus />
                                        </Grid>
                                        <Grid item sm={1} xs={2}>
                 ...
                 */}
                <Grid item sm={3}>
                    <Card style={{ backgroundColor: '#f0f7f7', height: '100vh' }}>{chatStarted ? <UserInfo user={chatUser} userAvatar={userAvatar} /> : null}</Card>
                </Grid>
            </Grid>
        </>
    )
