  ...
  return (
    <TableContainer component={Paper} className={classes.root}>
      <Table className={classes.table} size="meduim" aria-label="a dense table">
        <TableHead>
          <TableRow>
            <TableCell> <span className={classes.titre} > NOM DU PROFESSEUR </span> </TableCell>
            <TableCell align="right"> <span className={classes.titre} > MODULE DU PROFESSEUR </span> </TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
